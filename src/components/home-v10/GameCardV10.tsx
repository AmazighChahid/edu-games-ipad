...
const CARD_GAP = 24; // Espacement entre les cartes dans le carousel
const CARD_BORDER_RADIUS = 28;
const PARALLAX_FACTOR = 0.075; // Intensité de l'effet parallaxe
const ILLUSTRATION_OFFSET = 60; // Décalage des illustrations vers la droite
...
const styles = StyleSheet.create({
  ...
  // Container pour l'effet parallaxe (plus large pour le décalage)
  parallaxContainer: {
    left: -80 + ILLUSTRATION_OFFSET,
    right: -80 - ILLUSTRATION_OFFSET,
  ...
  // ========================================
  // ILLUSTRATIONS - Matrices Magiques
  // ========================================
  matricesContainer: {
    position: 'absolute',
    top: 0,
